...
def generate_allurl(user_in_nub):
    url =  'http://www.xyzs.com/app/soft/all_all_hot_{}'
    # numb = [23,24,26,30,345,33,359,28,361,358,362,363,31,27,360,29]
    # for url_next in numb:
...
def writer_to_text(list):
    with open('app.text', 'a', encoding='utf-8')as f:
        for i in list:
